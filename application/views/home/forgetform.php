                        ...
                        <div class="col-md-12 max_height">
                            ...
                            <form  method="post" class="signin-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php   echo $this->uri->segment(3);         ?>" name="code" id="code" required>
        ...
        <script>
            $(document).ready(function(){
                $("#forget_btn").click(function(){
                    ...
                    $.post('<?php  echo base_url();      ?>Ajax/forget_update',{code:code,npass:npass,cpass:cpass},function(data,status){
                            $("#mssg").html(data);
                            // alert(data);
                            if(status=='success')
                            {
