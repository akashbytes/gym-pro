...
<form  method="post" action="<?php  echo base_url()  ?>/admindashboard/cateaddaction" >
<?php
...
<div class="col-sm-9">
<input type="text" class="form-control" name="cate_name" value="<?php echo set_value('cate_name'); ?>" id="cate_name">
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Add Category</button>
</div>
</div>
</form>
</div>
