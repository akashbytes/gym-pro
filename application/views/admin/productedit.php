...
<form  method="post" enctype="multipart/form-data" action="<?php  echo base_url();  ?>admindashboard/productedit/<?php   echo $this->uri->segment(3)  ?>/update" >
<?php
...
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_title" id="pro_title" value="<?php   echo $p_data['pro_title']    ?>">
...
<label class="col-sm-2 col-form-label ">Product Title</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_url" id="pro_url" value="<?php   echo $p_data['pro_url']    ?>">
...
<input type="hidden" name="edit_id" id="edit_id"  value="<?php  echo $p_data['pro_id']  ?>" >

<div class="form-group row">
<label class="col-sm-2 col-form-label ">Product Sku</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_sku" id="pro_sku" value="<?php   echo $p_data['pro_sku'];    ?>">
...
<div class="col-sm-10">
    <select name="pro_base_cate" id="pro_base_cate" class="form-control">
        ...
        {
            if($p_data['pro_category']==$row['c_id'])
            {
            ?>
...
<div class="col-sm-10">
    <select name="pro_cate" id="pro_cate" class="form-control">
      <option value="">--Sub Category--</option>
        <?php
        foreach ($s_data as $key => $row2) 
        {
            if($p_data['pro_sub_category']==$row2['s_id'])
            {
            ?>
            <option selected="" value="<?php  echo $row2['s_id']   ?>"><?php  echo $row2['s_name']   ?></option>
            <?php    
            }
            else
            {
            ?>
            <option value="<?php  echo $row2['s_id']   ?>"><?php  echo $row2['s_name']   ?></option>
            <?php    
            }
...
<div class="col-sm-10">
    <select name="pro_brand" id="pro_brand" class="form-control">
        ...
        <?php
        foreach ($b_data as $key => $row3) 
        {
            if($p_data['pro_brand']==$row3['b_id'])
            {
            ?>
            <option selected="" value="<?php  echo $row3['b_id']   ?>"><?php  echo $row3['b_name']   ?></option>
            <?php                
            }
            else
            {
            ?>
            <option value="<?php  echo $row3['b_id']   ?>"><?php  echo $row3['b_name']   ?></option>
            <?php                
            }
...
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_quantity" id="pro_quantity" value="<?php   echo $p_data['pro_quantity'];    ?>">
...
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_price" id="pro_price" value="<?php   echo $p_data['pro_price'];    ?>">
...
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_sale_price" id="pro_sale_price" value="<?php   echo $p_data['pro_sale_price'];    ?>">
...
<div class="col-sm-10">
<textarea class="form-control" name="pro_sort_desc" id="pro_sort_desc" ><?php   echo $p_data['pro_sort_desc'];    ?></textarea>
...
<div class="col-sm-10">
<textarea class="form-control" name="pro_desc" id="pro_desc" ><?php   echo $p_data['pro_full_desc'];    ?></textarea>
...
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_meta_content" id="pro_meta_content" value="<?php   echo $p_data['pro_meta_content'];    ?>">
...
<div class="col-sm-10">
<input type="text" class="form-control" name="pro_meta_keyword" id="pro_meta_keyword" value="<?php   echo $p_data['pro_meta_keyword'];    ?>">
...
<div class="col-sm-2">
    ...
    <div class="col-sm-10">
    <input type="checkbox" <?php  if($p_data['pro_popular']=="1"){echo "checked";} ?> name="pro_popular" value="1" >Popular Product &nbsp;&nbsp;
    <input type="checkbox" <?php  if($p_data['pro_hot']=="1"){echo "checked";} ?> name="pro_hot" value="1" >Hot Deals &nbsp;&nbsp;
    <input type="checkbox" <?php  if($p_data['pro_new']=="1"){echo "checked";} ?> name="pro_new" value="1" >New Arrival &nbsp;&nbsp;
    <input type="checkbox" <?php  if($p_data['pro_best']=="1"){echo "checked";} ?> name="pro_best" value="1" >Best Selling Product &nbsp;&nbsp;
    <input type="checkbox" <?php  if($p_data['pro_feat']=="1"){echo "checked";} ?> name="pro_feat" value="1" >Featured Product &nbsp;&nbsp;(Optional)
...
<span class="messages text-danger">Recomended size(1024x1024) <?php   echo @$upload_error;    ?></span>
    <br>
        <img src="<?php echo base_url()  ?>images/<?php echo $p_data['pro_feat_image']  ?>" height="100px"  />
    <br>
    <br>
</div>
</div>
...
<?php
$images=$p_data['pro_gallery_image'];
...
<span class="text-danger" >Click Over The Images To Delete</span>
</div>
</div>
...
$old_color=explode('/',$p_data['pro_color']);
...
<label class="col-sm-2"></label>
<div class="col-sm-10">
<button type="submit" name="add" class="btn btn-primary m-b-0">Update Product</button>
</div>
</div>
</form>
</div>
...
<script>
    ...
    function delete_image(img_name)
    {
        ...
        if(confirm('Are You Sure To Delete   ?'))
        {
            ...
            var pro_id=$("#edit_id").val();
            $.post('<?php echo base_url().'admindashboard/deleteimg'  ?>',{pro_id:pro_id,img_name:img_name},function(data,status){
                $("#gallery_fetch").html(data);
            });            
        }
