...
<li class="breadcrumb-item"><a href="#!">Brand View</a>
</li>
...
<tbody>
 	...
 	foreach($c_data as $key=>$row) 
    {
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/brandedit/'.$row['b_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/brandview/deactive/'.$row['b_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/brandview/active/'.$row['b_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/brandview/delete/'.$row['b_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
