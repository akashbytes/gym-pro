...
<li class="breadcrumb-item"><a href="#!">Inbox View</a>
</li>
...
<tbody>
 	...
 	foreach($data as $key=>$row) 
    {
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/inbox/delete/'.$row['con_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
        <tr>
            <td colspan="6" class="text-center">
                <b>Message :</b> <?php  echo $row['con_message'] ?>
            </td>
        </tr>
        <?php
    }
