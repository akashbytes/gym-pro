...
<li class="breadcrumb-item"><a href="#!">Contact Page CMS</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url()  ?>admindashboard/contactpage/update" >
<?php
...
<label class="col-sm-3 col-form-label text-right">Email Section </label>
<div class="col-sm-9">
    <textarea class="form-control"   name="c_email"  ><?php  echo $c_data['c_email']  ?></textarea>
<span class="messages text-danger"><?php  echo form_error('c_email')  ?></span>
</div>
</div>


<div class="form-group row">
<label class="col-sm-3 col-form-label text-right">Address Section </label>
<div class="col-sm-9">
    <textarea class="form-control"   name="c_address"  ><?php  echo $c_data['c_address']  ?></textarea>
<span class="messages text-danger"><?php  echo form_error('c_address')  ?></span>
</div>
</div>


<div class="form-group row">
<label class="col-sm-3 col-form-label text-right">Phone Section </label>
<div class="col-sm-9">
    <textarea class="form-control"   name="c_phone"  ><?php  echo $c_data['c_phone']  ?></textarea>
<span class="messages text-danger"><?php  echo form_error('c_phone')  ?></span>
</div>
</div>
