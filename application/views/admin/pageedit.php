...
<form  method="post" action="<?php  echo base_url();  ?>admindashboard/pageedit/<?php   echo $this->uri->segment(3)  ?>/update" >
<?php
...
<div class="col-sm-10">
<input type="text" class="form-control" value="<?php  echo $row['p_title']   ?>" name="p_title" id="p_title">
...
<div class="col-sm-10">
<input type="text" class="form-control" value="<?php  echo $row['p_url']   ?>" name="p_url" id="p_url">
...
<div class="col-sm-10">
<input type="text" class="form-control"  value="<?php  echo $row['p_heading']   ?>" name="p_heading" id="p_heading">
...
<div class="col-sm-10">
<input type="text" class="form-control" name="p_meta" value="<?php  echo $row['p_meta_desc']   ?>" id="p_meta">
...
<div class="col-sm-10">
<input type="text" class="form-control" value="<?php  echo $row['p_keyword']   ?>" name="p_keyword" id="p_keyword">
