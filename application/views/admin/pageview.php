...
<li class="breadcrumb-item"><a href="#!">Page View</a>
</li>
...
<tbody>
 	...
 	foreach($p_data as $key=>$row) 
    {
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/pageedit/'.$row['p_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/pageview/deactive/'.$row['p_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/pageview/active/'.$row['p_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/pageview/delete/'.$row['p_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
