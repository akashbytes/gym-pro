...
<li class="breadcrumb-item"><a href="#!">Category View</a>
</li>
...
<tbody>
 	...
 	foreach($c_data as $key=>$row) 
    {
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/cateedit/'.$row['c_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/cateview/deactive/'.$row['c_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/cateview/active/'.$row['c_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/cateview/delete/'.$row['c_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
