...
<li class="breadcrumb-item"><a href="#!">Color Update</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url()  ?>/admindashboard/coloredit/<?php   echo $this->uri->segment(3)  ?>/update" >
<?php
...
<div class="col-sm-9">
<input type="text" class="form-control" name="color_name" value="<?php   echo $c_data['c_name'];   ?>" id="color_name">
...
<div class="col-sm-9">
<input type="text" class="form-control" name="color_code" value="<?php   echo $c_data['c_code'];   ?>" id="color_code">
<span class="messages text-danger"><?php  echo form_error('color_code')  ?></span>
</div>
</div>

<div class="form-group row">
<label class="col-sm-3 col-form-label text-right">Color Preview</label>
<div class="col-sm-9">
<div style="height:100px;width:100%;background-color:<?php   echo $c_data['c_code'];   ?>!important;"></div>
</div>
</div>
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Update Color</button>
</div>
</div>
</form>
</div>
