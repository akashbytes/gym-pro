...
<li class="breadcrumb-item"><a href="#!">Slider View</a>
</li>
...
<tbody>
 	...
 	foreach($images as $key=>$row) 
    {
        ...
        <td><?php echo $row['sl_order'];  ?></td>
        <td>
            <a href="<?php echo base_url().'admindashboard/slideredit/'.$row['sl_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/sliderview/deactive/'.$row['sl_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/sliderview/active/'.$row['sl_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/sliderview/delete/'.$row['sl_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
