...
<li class="breadcrumb-item"><a href="#!">Shipping</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url()  ?>admindashboard/shipping/update" >
<?php
...
<label class="col-sm-3 col-form-label text-right">Shipping  Price</label>
<div class="col-sm-9">
<input type="text" class="form-control" name="s_price" value="<?php echo $s_data['s_price'] ?>" id="s_price">
<span class="messages text-danger"><?php  echo form_error('s_price')  ?></span>
</div>
</div>
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Update Shipping</button>
</div>
</div>
</form>
</div>
