...
<!-- Mirrored from colorlib.com//polygon/admindek/default/dashboard-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Feb 2019 05:17:39 GMT -->
...
<!-- <script type="text/javascript" src="<?php   echo base_url();  ?>files/nicEdit.js"></script>
 -->
</head>
<body>
...
<li>
	 <button onclick="history.go(-1);" class="btn btn-info  btn-sm  back_btn">
     <i class="fas fa-arrow-left"></i> Back</button>

</li>
<li>
	 <button onclick="window.location.href='<?php   echo base_url()  ?>admindashboard/language/en'" class="btn btn-primary  btn-sm  back_btn">English</button>
	|
	 <button onclick="window.location.href='<?php   echo base_url()  ?>admindashboard/language/ar'" class="btn btn-success  btn-sm  back_btn">Arabic</button>
...
<div class="dropdown-primary dropdown">
<div class="dropdown-toggle" data-toggle="dropdown">
<img src="<?php  echo base_url();   ?>files/assets/images/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
<span>Admin</span>
<i class="feather icon-chevron-down"></i>
</div>
<ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
<li>
<a href="<?php   echo base_url() ?>admindashboard/settings">
<i class="feather icon-settings"></i> Settings
</a>
</li>
<li>
<a href="<?php  echo base_url().'admindashboard/logout'  ?>">
...
<li class="">
<a href="<?php echo base_url(); ?>admindashboard/cateadd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>
<li class="active">
<a href="<?php echo base_url(); ?>admindashboard/cateview" class="waves-effect waves-dark">
...
<ul class="pcoded-submenu">
<li class="">
<a href="<?php  echo base_url();  ?>admindashboard/subcateadd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>
<li class="active">
<a href="<?php  echo base_url();  ?>admindashboard/subcateview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>
</ul>
...
<li class="">
<a href="<?php  echo base_url();  ?>admindashboard/slideradd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
</a>
</li>
<li class="">
<a href="<?php  echo base_url();  ?>admindashboard/sliderview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>
...
<ul class="pcoded-submenu">
<li class="">
<a href="<?php echo base_url(); ?>admindashboard/productadd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>
<li class="active">
<a href="<?php echo base_url(); ?>admindashboard/productview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>
</ul>
...
<span class="pcoded-mtext">Coupens</span>
</a>
<ul class="pcoded-submenu">
<li class="">
<a href="<?php  echo base_url();    ?>admindashboard/couponadd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>
<li class="active">
<a href="<?php  echo base_url();    ?>admindashboard/couponview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>
</ul>
...
<li class="">
<a href="<?php   echo base_url() ?>admindashboard/inbox" class="waves-effect waves-dark">
<span class="pcoded-micon">
<i class="feather icon-clipboard"></i>
</span>
<span class="pcoded-mtext">Contact Mails</span>
</a>
</li>


<li class="">
<a href="<?php   echo base_url() ?>admindashboard/orders" class="waves-effect waves-dark">
<span class="pcoded-micon">
<i class="feather icon-clipboard"></i>
</span>
...
<li class="">
<a href="<?php   echo base_url() ?>admindashboard/customers" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
<li class="">
<a href="<?php echo base_url();   ?>admindashboard/shipping" class="waves-effect waves-dark">
<span class="pcoded-micon">
...
if($this->session->admin_type=="user")
{
...
<ul class="pcoded-submenu">
<li class="">
<a href="<?php  echo base_url();  ?>admindashboard/coloradd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>
<li class="active">
<a href="<?php  echo base_url();  ?>admindashboard/colorview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>
</ul>
...
<ul class="pcoded-submenu">
<li class="">
<a href="<?php echo base_url(); ?>admindashboard/brandadd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>
<li class="active">
<a href="<?php echo base_url(); ?>admindashboard/brandview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>
</ul>
...
<ul class="pcoded-submenu">
<li class="">
<a href="<?php  echo base_url();    ?>admindashboard/pageadd" class="waves-effect waves-dark">
<span class="pcoded-mtext">Add</span>
 </a>
</li>

<li class="active">
<a href="<?php  echo base_url();    ?>admindashboard/pageview" class="waves-effect waves-dark">
<span class="pcoded-mtext">View</span>
</a>
</li>

<li class="">
<a href="<?php  echo base_url();    ?>admindashboard/aboutpage" class="waves-effect waves-dark">
...
<li class="">
<a href="<?php  echo base_url();    ?>admindashboard/contactpage" class="waves-effect waves-dark">
<span class="pcoded-mtext">Contact Page</span>
 </a>
</li>
