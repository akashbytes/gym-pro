...
<li class="breadcrumb-item"><a href="#!">Brand Add</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url()  ?>/admindashboard/brandaddaction" >
<?php
...
<div class="col-sm-9">
<input type="text" class="form-control" name="brand_name" value="<?php echo set_value('brand_name'); ?>" id="brand_name">
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Add Brand</button>
</div>
</div>
</form>
</div>
