...
<li class="breadcrumb-item"><a href="#!">Sub Category View</a>
</li>
...
<tbody>
 	...
 	foreach($s_data as $key=>$row) 
    {
        ...
        <td>
            <?php
            foreach ($c_data as $key2 => $row2) 
            {
                if ($row2['c_id']==$row['s_cate_id']) 
                {
                    echo $row2['c_name'];
                }
            }
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/subcateedit/'.$row['s_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/subcateview/deactive/'.$row['s_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/subcateview/active/'.$row['s_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/subcateview/delete/'.$row['s_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
