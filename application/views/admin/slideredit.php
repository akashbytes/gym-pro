...
<li class="breadcrumb-item"><a href="#!">Slider Update</a>
</li>
</ul>
</div>
</div>
...
<form method="post" enctype="multipart/form-data" action="<?php  echo base_url();  ?>admindashboard/slideredit/<?php   echo $this->uri->segment(3)  ?>/update">
<?php
...
<span class="text-danger">Recommended Size(450x450)</span>    
 ...
 <br>
 <br>
 <img src="<?php echo base_url();    ?>/images/<?php  echo $row['sl_image'];   ?>" height="100px">
 <br>
 <br>
...
<textarea name="sl_text" class="form-control"><?php echo $row['sl_text']; ?></textarea>
...
<div class="col-sm-10">
<input type="text" class="form-control" value="<?php echo $row['sl_link_text']; ?>" name="sl_link_text" id="sl_link_text">
...
<div class="col-sm-10">
<input type="text" class="form-control" name="sl_link" value="<?php echo $row['sl_link']; ?>" id="sl_link">
<span class="messages text-danger"><?php echo form_error('sl_link') ?></span>
</div>
</div>

<div class="form-group row">
<label class="col-sm-2 col-form-label text-right">Order</label>
<div class="col-sm-10">
<input type="text" class="form-control" name="sl_order" value="<?php echo $row['sl_order']; ?>" id="sl_order">
<span class="messages text-danger"><?php echo form_error('sl_order') ?></span>
</div>
</div>
...
<div class="col-sm-10">
    <button type="submit" name="add" class="btn btn-primary m-b-0">Update Slider</button>
</div>
</div>
</form>
</div>
