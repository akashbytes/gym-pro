...
<form  method="post" action="<?php  echo base_url();  ?>admindashboard/cateedit/<?php   echo $this->uri->segment(3)  ?>/update" >
<?php
...
<label class="col-sm-3 col-form-label text-right">Category Name</label>
<div class="col-sm-9">
<input type="text" class="form-control" value="<?php echo $row['c_name'];  ?>" name="cate_name" id="cate_name">
<span class="messages text-danger"><?php  echo form_error('cate_name')  ?></span>
</div>
</div>

<div class="form-group row">
<label class="col-sm-3 col-form-label text-right">Category Order</label>
<div class="col-sm-9">
<input type="text" class="form-control" value="<?php echo $row['c_order'];  ?>" name="cate_order" id="cate_order">
<span class="messages text-danger"><?php  echo form_error('cate_order')  ?></span>
</div>
</div>
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Update Category</button>
</div>
</div>
</form>
</div>
