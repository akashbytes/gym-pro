...
<li class="breadcrumb-item"><a href="#!">Sub Category Add</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url()  ?>/admindashboard/subcateaddaction" >
<?php
...
<div class="col-sm-9">
<input type="text" class="form-control" value="<?php echo set_value('sub_cate_name'); ?>" name="sub_cate_name" id="sub_cate_name">
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Add Sub Category</button>
</div>
</div>
</form>
</div>
