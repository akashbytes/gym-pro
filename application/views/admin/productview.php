...
<li class="breadcrumb-item"><a href="#!">Products View</a>
</li>
...
<tbody>
 	...
 	foreach($p_data as $key=>$row) 
    {
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/productedit/'.$row['pro_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/productview/deactive/'.$row['pro_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/productview/active/'.$row['pro_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/productview/delete/'.$row['pro_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
