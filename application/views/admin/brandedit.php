...
<li class="breadcrumb-item"><a href="#!">Brand Update</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url();  ?>admindashboard/brandedit/<?php   echo $this->uri->segment(3)  ?>/update" >
<?php
...
<div class="col-sm-9">
<input type="text" class="form-control" value="<?php echo $row['b_name'];  ?>" name="brand_name" id="brand_name">
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Update Brand</button>
</div>
</div>
</form>
</div>
