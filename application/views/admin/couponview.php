...
<li class="breadcrumb-item"><a href="#!">Coupon View</a>
</li>
...
<tbody>
 	...
 	foreach($c_data as $key=>$row) 
    {
        ...
        <td><?php echo $row['cu_quantity'];  ?></td>        
        <td><?php echo $row['cu_type'];  ?></td>
        <td><?php echo $row['cu_rate'];  ?></td>
        <td><?php echo $row['cu_expiry'];  ?></td>
        
        <td>
            <a href="<?php echo base_url().'admindashboard/couponedit/'.$row['cu_id']; ?>" class="btn btn-info btn-sm">
                Update
            </a>
        </td>
        <td>
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/couponview/deactive/'.$row['cu_id']; ?>"  class="btn btn-success btn-sm">
                    Active
                </a>
                <?php
            }
            ...
            {
                ?>
                <a href="<?php echo base_url().'admindashboard/couponview/active/'.$row['cu_id']; ?>"  class="btn btn-danger btn-sm">
                    Deactive
                </a>
                <?php
        ...
        <td>
            <a href="<?php echo base_url().'admindashboard/couponview/delete/'.$row['cu_id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Delete')">
                Delete
            </a>
        </td>
        </tr>
