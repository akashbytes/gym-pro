...
<li class="breadcrumb-item"><a href="#!">Coupon Update</a>
</li>
</ul>
</div>
</div>
...
<form  method="post" action="<?php  echo base_url();  ?>admindashboard/couponedit/<?php   echo $this->uri->segment(3)  ?>/update" >
<?php
...
<div class="col-sm-9">
<input type="text" class="form-control" name="c_name" value="<?php echo $c_data['cu_name']; ?>" id="c_name">
...
<div class="col-sm-9">
    &nbsp;&nbsp;
<!--<input type="text" class="form-control" name="c_name" value="<?php echo $c_data['cu_name']; ?>" id="c_name">-->
<input type="radio"  name="c_type" value="flat" <?php if($c_data['cu_type']=="flat"){ echo "checked";}  ?> id="c_type">Flat &nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio"  name="c_type" value="percent" <?php if($c_data['cu_type']=="percent"){ echo "checked";}  ?> id="c_type">Percent
...
<div class="col-sm-9">
<input type="text" class="form-control" name="c_rate" value="<?php echo $c_data['cu_rate']; ?>" id="c_rate">
...
<div class="col-sm-9">
<input type="text" class="form-control" name="c_quantity" value="<?php echo $c_data['cu_quantity']; ?>" id="c_quantity">
...
<div class="col-sm-9">
<input type="date" class="form-control" name="c_expire" value="<?php echo $c_data['cu_expiry']; ?>" id="c_expire">
...
<div class="col-sm-9">
<button type="submit" name="add" class="btn btn-primary m-b-0">Update Coupon</button>
</div>
</div>
</form>
</div>
